...
nobel_living_science %>%
  ...
  facet_wrap(~ category) +
  labs(
    title = "Nobel Prize Winners in Science Categories",
    subtitle = "Comparing US-based vs Other laureates who won the Nobel Prize",
    x = "Country (US vs Other)",
...
nobel_living_science <- nobel_living_science %>%
  mutate(country_us = if_else(country == "USA", "US", "Other"))
```
